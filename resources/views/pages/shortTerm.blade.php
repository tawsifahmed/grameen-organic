    ...
    <div class="homepage-section">
        ...
        <div class="container home-intro-three" style="margin-top: -320px;">
            <div class="farmer-story">
                ...
                <p class="fs-3 text-start fw-normal ">Write what we do in two lines Max
                </p>
                <div class="container grid-container inv-cards">
                    <div class="row">
                      <div class="col-12 col-md-6 col-lg-4">
                        <div class="card">
                          <img class="card-img-top img-fluid" src="{{asset('assets/images/banners/inv-cards.png')}}" alt="Card image cap">
                          <div class="card-body">
